...
(function (HttpEndpoints) {
    ...
    HttpEndpoints["WALLET_UPDATE"] = "/wallet/update";
    HttpEndpoints["ASSET_DEFAULT"] = "/asset/defaults";
    HttpEndpoints["ASSET_SEARCH"] = "/asset/search";
    HttpEndpoints["USER_UPDATE"] = "/user/update";
